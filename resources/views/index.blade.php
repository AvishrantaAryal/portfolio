    ...
    <div id="page-wraper">
      ...
      <div class="responsive-nav">
        ...
        <div id="menu" class="menu">
          ...
          <div class="container">
            <div class="image">
              <a href="#"><img src="{{url('public/frontend/assets/images/author-image.jpg')}}" alt="" /></a>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="left-image">
                  <img src="{{url('public/frontend/assets/images/left-image.jpg')}}" alt="" />
                </div>
              </div>
              <div class="col-md-6">
            ...
            <div class="isotope-wrapper">
              ...
              <div class="isotope-box">
                ...
                <div class="isotope-item" data-type="people">
                  <figure class="snip1321">
                    <img
                      src="{{url('public/frontend/assets/images/portfolio-02.jpg')}}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{url('public/frontend/assets/images/portfolio-02.jpg')}}"
                ...
                <div class="isotope-item" data-type="animals">
                  <figure class="snip1321">
                    <img
                      src="{{url('public/frontend/assets/images/portfolio-03.jpg')}}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{url('public/frontend/assets/images/portfolio-03.jpg')}}"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="people">
                  <figure class="snip1321">
                    <img
                      src="{{url('public/frontend/assets/images/portfolio-04.jpg')}}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{url('public/frontend/assets/images/portfolio-04.jpg')}}"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="nature">
                  <figure class="snip1321">
                    <img
                      src="{{url('public/frontend/assets/images/portfolio-05.jpg')}}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{url('public/frontend/assets/images/portfolio-05.jpg')}}"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="animals">
                  <figure class="snip1321">
                    <img
                      src="{{url('public/frontend/assets/images/portfolio-06.jpg')}}"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="{{url('public/frontend/assets/images/portfolio-06.jpg')}}"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
